...
For an example of a decolonial approach, take a look at the [Turtle Island Decolonized project](https://decolonialatlas.wordpress.com/turtle-island-decolonized/){:target="_blank"}, which maps Indigenous place names across so-called North America. (Open the PDF [here](https://decolonialatlas.wordpress.com/wp-content/uploads/2023/10/turtle-island-decolonized-map-without-index.pdf){:target="_blank"}.) Additionally, the following map is from <em>Native Land Digital</em>. Please take a moment to explore [native-land.ca](https://native-land.ca/){:target="_blank"} and learn about the Indigenous territories, languages, and treaties in your area. Please find further readings on mapping, colonization, and decolonization at the bottom of this page.
