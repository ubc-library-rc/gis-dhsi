...
For an example of a decolonial approach, take a look at the [Turtle Island Decolonized project](https://decolonialatlas.wordpress.com/turtle-island-decolonized/){:target="_blank"}, which maps Indigenous place names across so-called North America (see [here](https://decolonialatlas.wordpress.com/wp-content/uploads/2023/10/turtle-island-decolonized-map-without-index.pdf){:target="_blank"} for the PDF). Additionally, the web map below is from <em>Native Land Digital</em>. Please take a moment to explore [native-land.ca](https://native-land.ca/){:target="_blank"} and learn about the Indigenous territories, languages, and treaties in your area. Further readings on mapping, colonization, and decolonization at the bottom of this page.
...
- [Decolonizing the Map: Recentering Indigenous Mappings](https://utppublishing.com/doi/pdf/10.3138/cart.53.3.intro){:target="_blank"} in a Special Issue of [Cartographica](https://muse.jhu.edu/issue/43059){:target="_blank"}
- [Decolonizing and Indigenizing the map](https://mediacoop.ca/node/119126){:target="_blank"}
- [Coming Home to Indigenous Place Names in Canada by Dr. Margaret Wickens Pearce](https://umaine.edu/canam/coming-home-map/){:target="_blank"}
...
- [Place in Research: Theory, Methodology, and Methods](https://www.researchgate.net/publication/281831514_Place_in_Research_Theory_Methodology_and_Methods){:target="_blank"}
