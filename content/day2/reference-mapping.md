...
<!-- in thematic section we wont focus on making actull output map but rather vector tools and calculations -->
...
explore bakers across diff demographic sets... then 

look at census, directory, and taxroll data. run selections on bakers. In the end, simple static reference map with (lots), BUILDINGS, CONTEXT FEATURES? because cant do choropleth or anything yet? Just to show how to make and export? is that okay? Ask alex tomorrow.  -->
