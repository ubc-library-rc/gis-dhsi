...
Today's lesson will provide a conceptual and practical orientation to geographic information systems (GIS), a software used to analyze, modify, and visualize spatial data. You will develop familiarity with [QGIS](https://qgis.org/) — a free and open-source GIS — by creating reference maps and thematic maps with two sets of data. 
