...
*2*{: .circle .circle-purple} To make your life easier while viewing or editing code, it's good to use a [source code editor](https://en.wikipedia.org/wiki/Source_code_editor). We recommend [Visual Studio Code](https://code.visualstudio.com/download) for this course. Please take a moment to install it now if you have not already.
...
<img src="./images/dev-setup1.jpeg" alt="vs-extensions" width="40%"/>
<img src="./images/dev-setup2.jpeg" alt="live-server" width="40%"/>
...
CUSTOMIZE FROM THIS POINT ONWARDS
[REFERENCE](https://ubc-library-rc.github.io/gis-intro-leaflet/content/hands-on1.html)

https://ubc-library-rc.github.io/gis-intro-leaflet/content/hands-on1.html
